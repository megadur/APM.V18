...
export class BaseService {
    protected basePath = 'http://localhost:9000/api/v1';
    public defaultHeaders = new HttpHeaders();
    public configuration: GutachtenportalConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: GutachtenportalConfiguration) {
        this.configuration = configuration || new GutachtenportalConfiguration();
