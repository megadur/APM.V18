...
// @ts-ignore
import { DocumentNoteDto } from '../model/documentNoteDto';
// @ts-ignore
import { DokumentDto } from '../model/dokumentDto';
// @ts-ignore
...
export class DokumenteApiClient extends BaseService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patchDocumentMetadata(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public patchDocumentMetadata(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public patchDocumentMetadata(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public patchDocumentMetadata(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        if (patchDocument === null || patchDocument === undefined) {
            throw new Error('Required parameter patchDocument was null or undefined when calling patchDocumentMetadata.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patchDocumentNote(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public patchDocumentNote(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public patchDocumentNote(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public patchDocumentNote(id: string, xOrgId: string, xUserId: string, xGutachterId: string, patchDocument: Array<PatchDocument>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling patchDocumentNote.');
        }
        if (xOrgId === null || xOrgId === undefined) {
            throw new Error('Required parameter xOrgId was null or undefined when calling patchDocumentNote.');
        }
        if (xUserId === null || xUserId === undefined) {
            throw new Error('Required parameter xUserId was null or undefined when calling patchDocumentNote.');
        }
        if (xGutachterId === null || xGutachterId === undefined) {
            throw new Error('Required parameter xGutachterId was null or undefined when calling patchDocumentNote.');
        }
        if (patchDocument === null || patchDocument === undefined) {
            throw new Error('Required parameter patchDocument was null or undefined when calling patchDocumentNote.');
        }
