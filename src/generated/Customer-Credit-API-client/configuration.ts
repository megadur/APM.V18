        ...
        if (!this.credentials['appKey']) {
            this.credentials['appKey'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    ...
                    return this.apiKeys['appKey'] || this.apiKeys['X-VTEX-API-AppKey'];
                }
            };
        }

        // init default appToken credential
        if (!this.credentials['appToken']) {
            this.credentials['appToken'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['appToken'] || this.apiKeys['X-VTEX-API-AppToken'];
                }
            };
        }
    }
